...
class Saidas
{
    ...
    public function read($std)
    {
        ...
        $data = [
            ...
            'endereco_numero' => substr($std->NFe->infNFe->dest->enderDest->nro, 0, 10),
            'endereco_complemento' => !empty($std->NFe->infNFe->dest->enderDest->xCpl) ? $std->NFe->infNFe->dest->enderDest->xCpl : $std->NFe->infNFe->dest->enderDest->nro,
